...
const routes: Routes = [
  ...
  { path: 'create', component: PostCreateComponent , canActivate: [AngularAuthGuard]},
  { path: 'create-community', component: CreateCommunityComponent , canActivate: [AngularAuthGuard]},
